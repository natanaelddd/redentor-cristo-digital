        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start space-y-8">
            <Link to="/" className="flex items-center">
              {siteContent.logo_url ? <img src={siteContent.logo_url} alt="Igreja Missionária Cristo Redentor" className="h-20 object-contain" /> : <img src="/lovable-uploads/church-logo-bw.png" alt="Igreja Missionária Cristo Redentor" className="h-20 object-contain" />}
            </Link>
          ...
          <div className="space-y-8">
            ...
            <nav className="flex flex-col gap-4">
              {navLinks.map(link => <a key={link.title} href={link.href} className="nav-elegant text-gray-400 hover:text-white transition-colors">
                  {link.title}
                </a>)}
            </nav>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-6 justify-center md:justify-start">
              <a href={siteContent.footer_instagram_url || '#'} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-all duration-300 hover:scale-110">
                <Instagram className="h-7 w-7" />
                <span className="sr-only">Instagram</span>
              </a>
              <a href={siteContent.footer_facebook_url || '#'} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-all duration-300 hover:scale-110">
